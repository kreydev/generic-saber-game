...
public class Player : MonoBehaviour
{
   ...
   void Update()
   {
      ...
      RSaber.localEulerAngles = new Vector3(-saber1rot.y, saber1rot.x, 0);
      RSaber.localPosition = saberOffset[0] + (Vector3)saber1pos;

      LSaber.localEulerAngles = new Vector3(-saber2rot.y, saber2rot.x, 0);
      LSaber.localPosition = saberOffset[1] + (Vector3)saber2pos;
   }
}